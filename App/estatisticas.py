...
def lista_melhor_funcionarios(cnx):
    sql11 = """SELECT fatura.idfuncionario, concat(funcionario.nome, " ",funcionario.apelido) as nome, count(fatura.idfuncionario) as numVendas FROM barcantina.fatura
    ...
    sql12 = """SELECT fatura.idfuncionario, concat(funcionario.nome, " ",funcionario.apelido) as nome, count(fatura.idfuncionario) as numVendas FROM barcantina.fatura
            INNER JOIN funcionario ON fatura.idfuncionario = funcionario.idfuncionario
            group by fatura.idfuncionario 
            order by idfuncionario desc"""

    sql21 = """SELECT fatura.idfuncionario, concat(funcionario.nome, " ",funcionario.apelido) as nome, count(fatura.idfuncionario) as numVendas FROM barcantina.fatura
            INNER JOIN funcionario ON fatura.idfuncionario = funcionario.idfuncionario
            group by fatura.idfuncionario 
            order by nome asc"""
    sql22 = """SELECT fatura.idfuncionario, concat(funcionario.nome, " ",funcionario.apelido) as nome, count(fatura.idfuncionario) as numVendas FROM barcantina.fatura
            INNER JOIN funcionario ON fatura.idfuncionario = funcionario.idfuncionario
            group by fatura.idfuncionario 
            order by nome desc"""

    sql31 = """SELECT fatura.idfuncionario, concat(funcionario.nome, " ",funcionario.apelido) as nome, count(fatura.idfuncionario) as numVendas FROM barcantina.fatura
            INNER JOIN funcionario ON fatura.idfuncionario = funcionario.idfuncionario
            group by fatura.idfuncionario 
            order by numVendas asc"""
    sql32 = """SELECT fatura.idfuncionario, concat(funcionario.nome, " ",funcionario.apelido) as nome, count(fatura.idfuncionario) as numVendas FROM barcantina.fatura
            INNER JOIN funcionario ON fatura.idfuncionario = funcionario.idfuncionario
            group by fatura.idfuncionario 
